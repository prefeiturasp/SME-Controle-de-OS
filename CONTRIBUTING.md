...
[issues do GitHub](https://github.com/prefeiturasp/SME-Controle-de-OS/issues). Porém antes
...
[criar uma nova issue](https://github.com/prefeiturasp/SME-Controle-de-OS/issues/new). 
...
1. Certifique-se de que sua ideia já não esteja sendo abordada dentro do conjuntos de issues [issues do GitHub](https://github.com/prefeiturasp/SME-Controle-de-OS/issues/new);
...
[criar uma nova issue](https://github.com/prefeiturasp/SME-Controle-de-OS/issues/new) usando
o label **recurso**.
...
- Ajude com a documentação do projeto [nossa wiki](https://github.com/prefeiturasp/SME-Controle-de-OS/wiki);
